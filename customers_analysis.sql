...
--which are the top 5 product with the higest of the review rating??
...
--do subscribed customer spend more? comapre avarage spand and total revanue between subscribres and non-subscribres.
...
ORDER BY total_revenu , avg_spend;
...
--segment customers into new , returning,and loyal based on their total nummber of previous purchases,and show the count each segment.
